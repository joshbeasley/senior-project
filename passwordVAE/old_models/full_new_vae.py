...
infile = open("../datasets/full_rockyou_train.txt")
...
variational_autoencoder.fit(one_hot_encoded_train, one_hot_encoded_train, epochs=4, batch_size=64)


variational_autoencoder.save("full_new_vae")
variational_decoder.save("full_new_vae_decoder")
with open('full_new_vae_charset.pickle', 'wb') as handle:
