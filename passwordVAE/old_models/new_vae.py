...
infile = open("../datasets/100K_rockyou_train.txt")
...
variational_autoencoder.fit(one_hot_encoded_train, one_hot_encoded_train, epochs=10, batch_size=64)


variational_autoencoder.save("new_vae")
variational_decoder.save("new_vae_decoder")
with open('new_vae_charset.pickle', 'wb') as handle:
